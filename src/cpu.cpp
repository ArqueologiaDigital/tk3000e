...
/*
#define READ	mem_read(addr)
#define WRITE(valor) mem_write(addr, (byte)valor);
*/
...
#define ABSIINDX addr = mem_readw(mem_readw(regs.pc, 1)+(WORD)regs.x, 1);	\
					regs.pc += 2;

#define ABSX	{															\
					WORD addr2 = mem_readw(regs.pc, 1) & 0xFF00;			\
					addr = mem_readw(regs.pc, 1) + (WORD)regs.x;			\
					regs.pc += 2;											\
					if ((addr & 0xFF00) != addr2 && !WM) CYC(1)				\
				}
#define ABSY	{															\
					WORD addr2 = mem_readw(regs.pc, 1) & 0xFF00;			\
					addr = mem_readw(regs.pc, 1) + (WORD)regs.y;			\
					regs.pc += 2;											\
					if ((addr & 0xFF00) != addr2 && !WM) CYC(1)				\
				}
...
#define INDY	{															\
					WORD addr2 = mem_readw(mem_readb(regs.pc, 1), 1) & 0xFF00;	\
					addr = mem_readw(mem_readb(regs.pc++, 1), 1)+(WORD)regs.y;	\
					if ((addr & 0xFF00) != addr2 && !WM) CYC(1)		\
				}
#define IZPG     addr = mem_readw(mem_readb(regs.pc++, 1), 1);
...
#define TYA      regs.a = regs.y;                                           \
                 SETNZ(regs.a)
#define INVALID1
#define INVALID2 if (1) ++regs.pc;
#define INVALID3 if (1) regs.pc += 2;
...
DWORD InternalCpuExecute (DWORD totalcycles)
{
	...
	do {
		...
		fflush(arquivocpu);
#endif
		if (CPUAtual == CPU65C02)
		{
			MemAtualizaSlotExt(regs.pc);
			VideoUpdateVbl();
			switch (mem_readb(regs.pc++, 1))
			{
				...
				case 0x11: WM=0; INDY ORA      CYC(5)  break;
				...
				case 0x19: WM=0; ABSY ORA      CYC(4)  break;
				case 0x1A:       INA           CYC(2)  break;
				case 0x1B:       INVALID1      CYC(1)  break;
				case 0x1C:       ABS TRB       CYC(6)  break;
				case 0x1D: WM=0; ABSX ORA      CYC(4)  break;
				case 0x1E: WM=1; ABSX ASL      CYC(6)  break;
				...
				case 0x31: WM=0; INDY AND      CYC(5)  break;
				...
				case 0x39: WM=0; ABSY AND      CYC(4)  break;
				case 0x3A:       DEA           CYC(2)  break;
				case 0x3B:       INVALID1      CYC(1)  break;
				case 0x3C: WM=0; ABSX BIT      CYC(4)  break;
				case 0x3D: WM=0; ABSX AND      CYC(4)  break;
				case 0x3E: WM=1; ABSX ROL      CYC(6)  break;
				...
				case 0x51: WM=0; INDY EOR      CYC(5)  break;
				...
				case 0x59: WM=0; ABSY EOR      CYC(4)  break;
				case 0x5A:       PHY           CYC(3)  break;
				case 0x5B:       INVALID1      CYC(1)  break;
				case 0x5C:       INVALID3      CYC(8)  break;
				case 0x5D: WM=0; ABSX EOR      CYC(4)  break;
				case 0x5E: WM=1; ABSX LSR      CYC(6)  break;
				...
				case 0x71: WM=0; INDY ADC      CYC(5)  break;
				...
				case 0x79: WM=0; ABSY ADC      CYC(4)  break;
				case 0x7A:       PLY           CYC(4)  break;
				case 0x7B:       INVALID1      CYC(1)  break;
				case 0x7C:       ABSIINDX JMP  CYC(6)  break;
				case 0x7D: WM=0; ABSX ADC      CYC(4)  break;
				case 0x7E: WM=1; ABSX ROR      CYC(6)  break;
				case 0x7F:       INVALID1      CYC(1)  break;
				case 0x80:       REL BRA       CYC(3)  break;
				...
				case 0x91: WM=1; INDY STA      CYC(6)  break;
				...
				case 0x99: WM=1; ABSY STA      CYC(5)  break;
				case 0x9A:       TXS           CYC(2)  break;
				case 0x9B:       INVALID1      CYC(1)  break;
				case 0x9C:       ABS STZ       CYC(4)  break;
				case 0x9D: WM=1; ABSX STA      CYC(5)  break;
				case 0x9E: WM=1; ABSX STZ      CYC(5)  break;
				...
				case 0xB1: WM=0; INDY LDA      CYC(5)  break;
				...
				case 0xB9: WM=0; ABSY LDA      CYC(4)  break;
				case 0xBA:       TSX           CYC(2)  break;
				case 0xBB:       INVALID1      CYC(1)  break;
				case 0xBC: WM=0; ABSX LDY      CYC(4)  break;
				case 0xBD: WM=0; ABSX LDA      CYC(4)  break;
				case 0xBE: WM=0; ABSY LDX      CYC(4)  break;
				...
				case 0xD1: WM=0; INDY CMP      CYC(5)  break;
				...
				case 0xD9: WM=0; ABSY CMP      CYC(4)  break;
				case 0xDA:       PHX           CYC(3)  break;
				case 0xDB:       INVALID1      CYC(1)  break;
				case 0xDC:       INVALID3      CYC(4)  break;
				case 0xDD: WM=0; ABSX CMP      CYC(4)  break;
				case 0xDE: WM=1; ABSX DEC      CYC(6)  break;
				...
				case 0xF1: WM=0; INDY SBC      CYC(5)  break;
				...
				case 0xF9: WM=0; ABSY SBC      CYC(4)  break;
				case 0xFA:       PLX           CYC(4)  break;
				case 0xFB:       INVALID1      CYC(1)  break;
				case 0xFC:       INVALID3      CYC(4)  break;
				case 0xFD: WM=0; ABSX SBC      CYC(4)  break;
				case 0xFE: WM=1; ABSX INC      CYC(6)  break;
...
//===========================================================================
void CpuGetCode (WORD address, char* *codeptr, DWORD *codelength)
{
	*codeptr    = NULL;
	*codelength = 0;
}
...
void CpuSetupBenchmark ()
{
	...
	// CREATE CODE SEGMENTS CONSISTING OF GROUPS OF COMMONLY-USED OPCODES
	{
		...
		do
		{
			mem_writeb(addr++, benchopcode[opcode]);
			mem_writeb(addr++, benchopcode[opcode]);
			if (opcode >= SHORTOPCODES)
				mem_writeb(addr++, 0);
			if ((++opcode >= BENCHOPCODES) || ((addr & 0x0F) >= 0x0B))
			{
				mem_writeb(addr++, 0x4C);
				mem_writeb(addr++, (opcode >= BENCHOPCODES) ? 0x00 : ((addr >> 4)+1) << 4);
				mem_writeb(addr++, 0x03);
				while (addr & 0x0F)
					++addr;
			}
